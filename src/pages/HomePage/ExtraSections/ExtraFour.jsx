        ...
        <div><section class="bg-white dark:bg-gray-900">
            <div class="container px-6 py-12 mx-auto">
                <div class="text-center">
                    <p class="font-medium text-orange-600   dark:text-blue-400">Contact us</p>
                ...
                <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                    <div class="flex flex-col items-center justify-center text-center">
                        <span class="p-3 text-orange-600   rounded-full bg-blue-100/80 dark:bg-gray-800">
                            <svg xmlns="http://www.w3.org/1000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <p class="mt-2 text-orange-600   dark:text-blue-400">hello@merakiui.com</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center text-center">
                        ...
                        <p class="mt-2 text-orange-600   dark:text-blue-400">100 Smith Street Collingwood VIC 3066 AU</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center text-center">
                        ...
                        <p class="mt-2 text-orange-600   dark:text-blue-400">+1 (555) 000-0000</p>
                    </div>
                </div>
            </div>
        </section>
